...
const proxy=http.createServer(async(req,res)=>{
  ...
  if(u.pathname==='/admin.js'&&req.method==='GET')return appendScript(res,'/admin.js',['admin-carousel.js','admin-content-fix.js','admin-currency.js','admin-frontend-manager.js']);
