...
const BRAND_ALIASES={MERCEDES:'Mercedes-Benz','MERCEDES-BENZ':'Mercedes-Benz',AUDI:'Audi',SUPRA:'Toyota'};
function canonicalBrand(v){const t=tidy(v);return BRAND_ALIASES[t.toUpperCase()]||t}
function brandVariants(v){const c=canonicalBrand(v);const set=new Set([c]);for(const [k,val] of Object.entries(BRAND_ALIASES))if(val===c)set.add(k);return [...set]}
